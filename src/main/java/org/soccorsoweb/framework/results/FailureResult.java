 ...
 */
package org.soccorsoweb.framework.results;
...
public class FailureResult {
    ...
    public void activate(String message, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            // ATTENZIONE: in un ambiente di produzione, i messaggi di errore DEVONO essere
            // limitati a informazioni generiche, non a stringhe complete di eccezione
